...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        point = rg.Point(x,y)
        self.circle = rg.Circle(point,radius)
        self.circle.fill_color = fill_color
        self.colors = colors
        self.og_fill_color = fill_color
        self.index = 0
    ...
    def get_distance_from(self, point):
        ...
        distance = point.get_distance_from(p2)
        return distance
    ...
    def swallow(self, other_circle_changer):
        ...
        return CircleChanger(circle.center.x,circle.center.y,radius,circle.fill_color,colors)
    ...
    def change_to_original_color(self):
        ...
        self.circle.fill_color = self.og_fill_color
